...
function Project({data,index}) {
    ...
    return (
        <Link href={`/projects/${index + 1}`} passHref>
            <div className="w-72 h-72  md:w-96 md:h-96 bg-red rounded-xl flex-nowrap cursor-pointer shadow hover:shadow-lg duration-500 hover:scale-105">
                <Image alt="project image" width={2400} height={2400} className="w-full rounded-t-xl h-4/6 object-cover" src={images[0] ?images[0] :  "/p-1.png"} />
