...
async function LandingPage() {
    ...
    return ( 
        <div className="bg-white m-0 p-0  font-sloth-light font-ps md:font-pl md:font-sloth-regular text-dark overflow-x-hidden 3xl:my-8">
            <section id="ABOUT" className=' relative min-h-screen md:min-h-fit   w-screen md:flex  md:gap-10 md:flex-row-reverse  px-4 md:px-32 py-8'>
                <Image alt="An Image of Zachary" width={1908} height={3392} className=" object-cover object-center w-full h-72 md:w-72 md:h-72 brightness-90  lg:w-96 lg:h-full  rounded-tl-[50px] rounded-tr-lg rounded-bl-lg rounded-br-[50px]  " src="/personalpic2web.webp" />
            ...
            <section id="TECH" className=' min-h-screen w-screen md:min-h-fit    relative  md:px-32   px-4 py-8'>
