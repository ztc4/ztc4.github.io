export const projectsData = [
  {
    ...
    goals: [
      "Get more familiar with making the backend using Springboot",
      "Storing and distributing videos efficiently",
      "Learning about Jira and managing projects through it",
    ],
    description: `A plaorm allowing users to upload educaonal videos with live chatrooms/comment system that allow potentially a more supportive community that provides live feedback  `,
    issues: `
     `,
    images: [
      "/po-1.svg"
    ...
    githubLink: "https://github.com/ztc4/Streaming-Application",
    deployment: "https://streaming-application-nine.vercel.app/signup",
    figma:
      "https://www.figma.com/design/oYGSlECRpp0CU79BTsH3qu/main-designs?node-id=0-1&t=kpSd1oD2bZHjClLf-1",
    techstack: [
      "Kotlin/Java",
      "Springboot",
      "Azure SQL",
  ...
  },
  {
    title: "ARTICLE CRAFT",
    goals: [
      "Learning how to correctly write unit test",
      "learn how to send images between the client and server side",
      "Learning how figma works by wireframing the project.",
    ],
    ...
    accomplishments: [
      ...
      "How to better optimize database queries and Fetches, allowing for less data used!",
      "Learned the basics of wireframing with figma, allowing me to make better designs and speed up development!",
      "Due to errors made in structure in frontend architecture, I learned what not to try again next time when structuring the pages and components!",
    ],
    githubLink: "https://github.com/ztc4/article-site",
    deployment: "https://article-site-ztc4.vercel.app/",
    figma:
      "https://www.figma.com/file/mjkmQIBiVHFlPSasqSnOMw/article?type=design&node-id=0-1&mode=design&t=tFWjTkFin2PkxHy4-0",
    techstack: [
      "Javascript",
      "Next.js",
      "React",
  ...
  },
  {
    ...
    goals: [
      "Learning about Vue and its ecosystem",
      " Make my first Large Spring Boot application",
      "Make a ai chatbot for a personal business",
      "Text to image, to alllow easy input of data using images",
    ],
    ...
    accomplishments: [
      ...
      "Gained some proficiency with Spring boot using Kotlin",
      "Learned a little about OCR",
      "Came up with creaive solutions to my problems",
    ],
    githubLink: null,
    deployment: null,
    figma:
  ...
  },
  {
    ...
    goals: [
      `Learn to create websites using material UI`,
      "do a little bit of refactoring of older code",
    ],
  ...
  },
  {
    title: "Portfolio",
    goals: [
      "Designing a site using figma and implementing it responsively",
      "Further practice wireframing and mapping out websites",
      "Further practice with Next.js not using the mistakes I previously used!",
    ],
    ...
    figma:
      "https://www.figma.com/file/L4BYc2wn8SjCwJAzm0gXAq/PORTFOLIO-DESIGN-WEB-PAGE?type=design&node-id=0-1&mode=design&t=WvWZbus4EZDAYPth-0",
    techstack: [
      "Javascript",
      "Next.js",
      "React",
